...
export default function GuardianRegisterScreen() {
  ...
  function handleNext() {
    if (!isValid) return;
    router.push('/(auth)/blind-register');
  }
  ...
  return (
    <ScrollView contentContainerStyle={styles.screen} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.section}>
        ...
        <TextInput style={styles.input} placeholder="e.g. Sarah Kamau" placeholderTextColor={C.muted} value={guardianName} onChangeText={setGuardianName} />
        ...
        <TextInput style={styles.input} placeholder={t('createPassword')} placeholderTextColor={C.muted} secureTextEntry value={password} onChangeText={setPassword} />
      </View>
      ...
      <View style={styles.section}>
        ...
        <TextInput style={styles.input} placeholder="e.g. James Kamau" placeholderTextColor={C.muted} value={blindUserName} onChangeText={setBlindUserName} />

        <Text style={[styles.label, { color: C.muted }]}>{t('relationship')}</Text>
        <TextInput style={styles.input} placeholder={t('relationshipHint')} placeholderTextColor={C.muted} value={relationship} onChangeText={setRelationship} />
      </View>
